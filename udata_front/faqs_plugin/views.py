...
blueprint = I18nBlueprint('gouvpt_faq', __name__,
...
def faq(section):
    ...
    try:
        ...
        if cached_page:
            ...
            return theme.render('custom/faqs.html', page_name=section, content=content)
        else:
            abort(404)
    else:
...
def redirect_acessibilidade():
    return redirect(url_for('gouvpt_faq.faq', section='acessibilidade'))
